...
def export_programada_acta_pdf(programada_id: int, current_uid: str = Depends(get_current_user_uid), db: Session = Depends(get_db)):
    ...
    header_data = [
        ...
        [Paragraph("<b>Matr\u00edcula PBA:</b>", style_bold), "Colegio Profesional de Seguridad e Higiene de la Provincia de Buenos Aires \u2013 LHS-004308",
    ...
    trainer_info = Paragraph("<b>HDI Consultores</b><br/>Instructor / Representante<br/><font size=7>Colegio Profesional de Seguridad e Higiene\nde la Provincia de Buenos Aires \u2013 LHS-004308 PBA</font><br/><font size=7>COPIME \u2013 L002175</font>", ParagraphStyle('CenterBold', parent=style_normal, alignment=TA_CENTER))
